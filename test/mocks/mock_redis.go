...
func (_m *MockRedis) Append(ctx context.Context, key string, value string) *redis.IntCmd {
...
func (_m *MockRedis) BLMove(ctx context.Context, source string, destination string, srcpos string, destpos string, timeout time.Duration) *redis.StringCmd {
...
func (_m *MockRedis) BLPop(ctx context.Context, timeout time.Duration, keys ...string) *redis.StringSliceCmd {
...
func (_m *MockRedis) BRPop(ctx context.Context, timeout time.Duration, keys ...string) *redis.StringSliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) BRPopLPush(ctx context.Context, source string, destination string, timeout time.Duration) *redis.StringCmd {
...
func (_m *MockRedis) BZPopMax(ctx context.Context, timeout time.Duration, keys ...string) *redis.ZWithKeyCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) BZPopMin(ctx context.Context, timeout time.Duration, keys ...string) *redis.ZWithKeyCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) BgRewriteAOF(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) BgSave(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) BitCount(ctx context.Context, key string, bitCount *redis.BitCount) *redis.IntCmd {
...
func (_m *MockRedis) BitField(ctx context.Context, key string, args ...interface{}) *redis.IntSliceCmd {
	var _ca []interface{}
...
func (_m *MockRedis) BitOpAnd(ctx context.Context, destKey string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) BitOpNot(ctx context.Context, destKey string, key string) *redis.IntCmd {
...
func (_m *MockRedis) BitOpOr(ctx context.Context, destKey string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) BitOpXor(ctx context.Context, destKey string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) BitPos(ctx context.Context, key string, bit int64, pos ...int64) *redis.IntCmd {
...
func (_m *MockRedis) ClientGetName(ctx context.Context) *redis.StringCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClientID(ctx context.Context) *redis.IntCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClientKill(ctx context.Context, ipPort string) *redis.StatusCmd {
...
func (_m *MockRedis) ClientKillByFilter(ctx context.Context, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) ClientList(ctx context.Context) *redis.StringCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClientPause(ctx context.Context, dur time.Duration) *redis.BoolCmd {
...
func (_m *MockRedis) ClusterAddSlots(ctx context.Context, slots ...int) *redis.StatusCmd {
...
func (_m *MockRedis) ClusterAddSlotsRange(ctx context.Context, min int, max int) *redis.StatusCmd {
...
func (_m *MockRedis) ClusterCountFailureReports(ctx context.Context, nodeID string) *redis.IntCmd {
...
func (_m *MockRedis) ClusterCountKeysInSlot(ctx context.Context, slot int) *redis.IntCmd {
...
func (_m *MockRedis) ClusterDelSlots(ctx context.Context, slots ...int) *redis.StatusCmd {
	_va := make([]interface{}, len(slots))
	for _i := range slots {
		_va[_i] = slots[_i]
	}
...
func (_m *MockRedis) ClusterDelSlotsRange(ctx context.Context, min int, max int) *redis.StatusCmd {
	ret := _m.Called(ctx, min, max)
...
func (_m *MockRedis) ClusterFailover(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClusterForget(ctx context.Context, nodeID string) *redis.StatusCmd {
	ret := _m.Called(ctx, nodeID)
...
func (_m *MockRedis) ClusterGetKeysInSlot(ctx context.Context, slot int, count int) *redis.StringSliceCmd {
...
func (_m *MockRedis) ClusterInfo(ctx context.Context) *redis.StringCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClusterKeySlot(ctx context.Context, key string) *redis.IntCmd {
...
func (_m *MockRedis) ClusterMeet(ctx context.Context, host string, port string) *redis.StatusCmd {
...
func (_m *MockRedis) ClusterNodes(ctx context.Context) *redis.StringCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClusterReplicate(ctx context.Context, nodeID string) *redis.StatusCmd {
	ret := _m.Called(ctx, nodeID)
...
func (_m *MockRedis) ClusterResetHard(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClusterResetSoft(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClusterSaveConfig(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ClusterSlaves(ctx context.Context, nodeID string) *redis.StringSliceCmd {
	ret := _m.Called(ctx, nodeID)
...
func (_m *MockRedis) ClusterSlots(ctx context.Context) *redis.ClusterSlotsCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) Command(ctx context.Context) *redis.CommandsInfoCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ConfigGet(ctx context.Context, parameter string) *redis.SliceCmd {
...
func (_m *MockRedis) ConfigResetStat(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ConfigRewrite(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ConfigSet(ctx context.Context, parameter string, value string) *redis.StatusCmd {
...
func (_m *MockRedis) Copy(ctx context.Context, sourceKey string, destKey string, db int, replace bool) *redis.IntCmd {
...
func (_m *MockRedis) DBSize(ctx context.Context) *redis.IntCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) DebugObject(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Decr(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) DecrBy(ctx context.Context, key string, decrement int64) *redis.IntCmd {
...
func (_m *MockRedis) Del(ctx context.Context, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) Dump(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Echo(ctx context.Context, message interface{}) *redis.StringCmd {
...
func (_m *MockRedis) Eval(ctx context.Context, script string, keys []string, args ...interface{}) *redis.Cmd {
	var _ca []interface{}
...
func (_m *MockRedis) EvalSha(ctx context.Context, sha1 string, keys []string, args ...interface{}) *redis.Cmd {
	var _ca []interface{}
...
func (_m *MockRedis) Exists(ctx context.Context, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) Expire(ctx context.Context, key string, expiration time.Duration) *redis.BoolCmd {
...
func (_m *MockRedis) ExpireAt(ctx context.Context, key string, tm time.Time) *redis.BoolCmd {
...
func (_m *MockRedis) ExpireGT(ctx context.Context, key string, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, expiration)
...
func (_m *MockRedis) ExpireLT(ctx context.Context, key string, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, expiration)
...
func (_m *MockRedis) ExpireNX(ctx context.Context, key string, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, expiration)
...
func (_m *MockRedis) ExpireXX(ctx context.Context, key string, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, expiration)
...
func (_m *MockRedis) FlushAll(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) FlushAllAsync(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) FlushDB(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) FlushDBAsync(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) GeoAdd(ctx context.Context, key string, geoLocation ...*redis.GeoLocation) *redis.IntCmd {
...
func (_m *MockRedis) GeoDist(ctx context.Context, key string, member1 string, member2 string, unit string) *redis.FloatCmd {
...
func (_m *MockRedis) GeoHash(ctx context.Context, key string, members ...string) *redis.StringSliceCmd {
...
func (_m *MockRedis) GeoPos(ctx context.Context, key string, members ...string) *redis.GeoPosCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) GeoRadius(ctx context.Context, key string, longitude float64, latitude float64, query *redis.GeoRadiusQuery) *redis.GeoLocationCmd {
...
func (_m *MockRedis) GeoRadiusByMember(ctx context.Context, key string, member string, query *redis.GeoRadiusQuery) *redis.GeoLocationCmd {
...
func (_m *MockRedis) GeoRadiusByMemberStore(ctx context.Context, key string, member string, query *redis.GeoRadiusQuery) *redis.IntCmd {
	ret := _m.Called(ctx, key, member, query)
...
func (_m *MockRedis) GeoRadiusStore(ctx context.Context, key string, longitude float64, latitude float64, query *redis.GeoRadiusQuery) *redis.IntCmd {
	ret := _m.Called(ctx, key, longitude, latitude, query)
...
func (_m *MockRedis) GeoSearch(ctx context.Context, key string, q *redis.GeoSearchQuery) *redis.StringSliceCmd {
...
func (_m *MockRedis) GeoSearchLocation(ctx context.Context, key string, q *redis.GeoSearchLocationQuery) *redis.GeoSearchLocationCmd {
	ret := _m.Called(ctx, key, q)
...
func (_m *MockRedis) GeoSearchStore(ctx context.Context, key string, store string, q *redis.GeoSearchStoreQuery) *redis.IntCmd {
...
func (_m *MockRedis) Get(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) GetBit(ctx context.Context, key string, offset int64) *redis.IntCmd {
...
func (_m *MockRedis) GetDel(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) GetEx(ctx context.Context, key string, expiration time.Duration) *redis.StringCmd {
	ret := _m.Called(ctx, key, expiration)
...
func (_m *MockRedis) GetRange(ctx context.Context, key string, start int64, end int64) *redis.StringCmd {
...
func (_m *MockRedis) GetSet(ctx context.Context, key string, value interface{}) *redis.StringCmd {
	ret := _m.Called(ctx, key, value)
...
func (_m *MockRedis) HDel(ctx context.Context, key string, fields ...string) *redis.IntCmd {
...
func (_m *MockRedis) HExists(ctx context.Context, key string, field string) *redis.BoolCmd {
...
func (_m *MockRedis) HGet(ctx context.Context, key string, field string) *redis.StringCmd {
	ret := _m.Called(ctx, key, field)
...
func (_m *MockRedis) HGetAll(ctx context.Context, key string) *redis.StringStringMapCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) HIncrBy(ctx context.Context, key string, field string, incr int64) *redis.IntCmd {
...
func (_m *MockRedis) HIncrByFloat(ctx context.Context, key string, field string, incr float64) *redis.FloatCmd {
	ret := _m.Called(ctx, key, field, incr)
...
func (_m *MockRedis) HKeys(ctx context.Context, key string) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) HLen(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) HMGet(ctx context.Context, key string, fields ...string) *redis.SliceCmd {
	_va := make([]interface{}, len(fields))
	for _i := range fields {
		_va[_i] = fields[_i]
	}
...
func (_m *MockRedis) HMSet(ctx context.Context, key string, values ...interface{}) *redis.BoolCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
...
func (_m *MockRedis) HRandField(ctx context.Context, key string, count int, withValues bool) *redis.StringSliceCmd {
...
func (_m *MockRedis) HScan(ctx context.Context, key string, cursor uint64, match string, count int64) *redis.ScanCmd {
...
func (_m *MockRedis) HSet(ctx context.Context, key string, values ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) HSetNX(ctx context.Context, key string, field string, value interface{}) *redis.BoolCmd {
...
func (_m *MockRedis) HVals(ctx context.Context, key string) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Incr(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) IncrBy(ctx context.Context, key string, value int64) *redis.IntCmd {
	ret := _m.Called(ctx, key, value)
...
func (_m *MockRedis) IncrByFloat(ctx context.Context, key string, value float64) *redis.FloatCmd {
	ret := _m.Called(ctx, key, value)
...
func (_m *MockRedis) Info(ctx context.Context, section ...string) *redis.StringCmd {
...
func (_m *MockRedis) Keys(ctx context.Context, pattern string) *redis.StringSliceCmd {
...
func (_m *MockRedis) LIndex(ctx context.Context, key string, index int64) *redis.StringCmd {
...
func (_m *MockRedis) LInsert(ctx context.Context, key string, op string, pivot interface{}, value interface{}) *redis.IntCmd {
...
func (_m *MockRedis) LInsertAfter(ctx context.Context, key string, pivot interface{}, value interface{}) *redis.IntCmd {
...
func (_m *MockRedis) LInsertBefore(ctx context.Context, key string, pivot interface{}, value interface{}) *redis.IntCmd {
	ret := _m.Called(ctx, key, pivot, value)
...
func (_m *MockRedis) LLen(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) LMove(ctx context.Context, source string, destination string, srcpos string, destpos string) *redis.StringCmd {
...
func (_m *MockRedis) LPop(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) LPopCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
...
func (_m *MockRedis) LPos(ctx context.Context, key string, value string, args redis.LPosArgs) *redis.IntCmd {
...
func (_m *MockRedis) LPosCount(ctx context.Context, key string, value string, count int64, args redis.LPosArgs) *redis.IntSliceCmd {
...
func (_m *MockRedis) LPush(ctx context.Context, key string, values ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) LPushX(ctx context.Context, key string, values ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) LRange(ctx context.Context, key string, start int64, stop int64) *redis.StringSliceCmd {
...
func (_m *MockRedis) LRem(ctx context.Context, key string, count int64, value interface{}) *redis.IntCmd {
...
func (_m *MockRedis) LSet(ctx context.Context, key string, index int64, value interface{}) *redis.StatusCmd {
...
func (_m *MockRedis) LTrim(ctx context.Context, key string, start int64, stop int64) *redis.StatusCmd {
	ret := _m.Called(ctx, key, start, stop)
...
func (_m *MockRedis) LastSave(ctx context.Context) *redis.IntCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) MGet(ctx context.Context, keys ...string) *redis.SliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) MSet(ctx context.Context, values ...interface{}) *redis.StatusCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) MSetNX(ctx context.Context, values ...interface{}) *redis.BoolCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) MemoryUsage(ctx context.Context, key string, samples ...int) *redis.IntCmd {
...
func (_m *MockRedis) Migrate(ctx context.Context, host string, port string, key string, db int, timeout time.Duration) *redis.StatusCmd {
...
func (_m *MockRedis) Move(ctx context.Context, key string, db int) *redis.BoolCmd {
...
func (_m *MockRedis) ObjectEncoding(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) ObjectIdleTime(ctx context.Context, key string) *redis.DurationCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) ObjectRefCount(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) PExpire(ctx context.Context, key string, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, expiration)
...
func (_m *MockRedis) PExpireAt(ctx context.Context, key string, tm time.Time) *redis.BoolCmd {
	ret := _m.Called(ctx, key, tm)
...
func (_m *MockRedis) PFAdd(ctx context.Context, key string, els ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, els...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) PFCount(ctx context.Context, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) PFMerge(ctx context.Context, dest string, keys ...string) *redis.StatusCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) PTTL(ctx context.Context, key string) *redis.DurationCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Persist(ctx context.Context, key string) *redis.BoolCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Ping(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) Pipeline() redis.Pipeliner {
	ret := _m.Called()
...
func (_m *MockRedis) Pipelined(ctx context.Context, fn func(redis.Pipeliner) error) ([]redis.Cmder, error) {
...
func (_m *MockRedis) PubSubChannels(ctx context.Context, pattern string) *redis.StringSliceCmd {
	ret := _m.Called(ctx, pattern)
...
func (_m *MockRedis) PubSubNumPat(ctx context.Context) *redis.IntCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) PubSubNumSub(ctx context.Context, channels ...string) *redis.StringIntMapCmd {
...
func (_m *MockRedis) Publish(ctx context.Context, channel string, message interface{}) *redis.IntCmd {
...
func (_m *MockRedis) Quit(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) RPop(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) RPopCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, count)
...
func (_m *MockRedis) RPopLPush(ctx context.Context, source string, destination string) *redis.StringCmd {
...
func (_m *MockRedis) RPush(ctx context.Context, key string, values ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) RPushX(ctx context.Context, key string, values ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, values...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) RandomKey(ctx context.Context) *redis.StringCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ReadOnly(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ReadWrite(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
// RedisLock provides a mock function with given fields: ctx, key, lockerID, expireTime
func (_m *MockRedis) RedisLock(ctx context.Context, key string, lockerID string, expireTime time.Duration) (bool, error) {
	ret := _m.Called(ctx, key, lockerID, expireTime)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration) bool); ok {
		r0 = rf(ctx, key, lockerID, expireTime)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, time.Duration) error); ok {
		r1 = rf(ctx, key, lockerID, expireTime)
	} else {
		r1 = ret.Error(1)
	}
...
// RedisUnlock provides a mock function with given fields: ctx, key, lockerID
func (_m *MockRedis) RedisUnlock(ctx context.Context, key string, lockerID string) error {
	ret := _m.Called(ctx, key, lockerID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) error); ok {
		r0 = rf(ctx, key, lockerID)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockRedis) Rename(ctx context.Context, key string, newkey string) *redis.StatusCmd {
...
func (_m *MockRedis) RenameNX(ctx context.Context, key string, newkey string) *redis.BoolCmd {
	ret := _m.Called(ctx, key, newkey)
...
func (_m *MockRedis) Restore(ctx context.Context, key string, ttl time.Duration, value string) *redis.StatusCmd {
...
func (_m *MockRedis) RestoreReplace(ctx context.Context, key string, ttl time.Duration, value string) *redis.StatusCmd {
	ret := _m.Called(ctx, key, ttl, value)
...
func (_m *MockRedis) SAdd(ctx context.Context, key string, members ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
...
func (_m *MockRedis) SCard(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) SDiff(ctx context.Context, keys ...string) *redis.StringSliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) SDiffStore(ctx context.Context, destination string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) SInter(ctx context.Context, keys ...string) *redis.StringSliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) SInterStore(ctx context.Context, destination string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) SIsMember(ctx context.Context, key string, member interface{}) *redis.BoolCmd {
...
func (_m *MockRedis) SMIsMember(ctx context.Context, key string, members ...interface{}) *redis.BoolSliceCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, members...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) SMembers(ctx context.Context, key string) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) SMembersMap(ctx context.Context, key string) *redis.StringStructMapCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) SMove(ctx context.Context, source string, destination string, member interface{}) *redis.BoolCmd {
...
func (_m *MockRedis) SPop(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) SPopN(ctx context.Context, key string, count int64) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, count)
...
func (_m *MockRedis) SRandMember(ctx context.Context, key string) *redis.StringCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) SRandMemberN(ctx context.Context, key string, count int64) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, count)
...
func (_m *MockRedis) SRem(ctx context.Context, key string, members ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, members...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) SScan(ctx context.Context, key string, cursor uint64, match string, count int64) *redis.ScanCmd {
	ret := _m.Called(ctx, key, cursor, match, count)
...
func (_m *MockRedis) SUnion(ctx context.Context, keys ...string) *redis.StringSliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) SUnionStore(ctx context.Context, destination string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) Save(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) Scan(ctx context.Context, cursor uint64, match string, count int64) *redis.ScanCmd {
...
func (_m *MockRedis) ScanType(ctx context.Context, cursor uint64, match string, count int64, keyType string) *redis.ScanCmd {
...
func (_m *MockRedis) ScriptExists(ctx context.Context, hashes ...string) *redis.BoolSliceCmd {
...
func (_m *MockRedis) ScriptFlush(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ScriptKill(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ScriptLoad(ctx context.Context, script string) *redis.StringCmd {
...
func (_m *MockRedis) Set(ctx context.Context, key string, value interface{}, expiration time.Duration) *redis.StatusCmd {
...
func (_m *MockRedis) SetArgs(ctx context.Context, key string, value interface{}, a redis.SetArgs) *redis.StatusCmd {
...
func (_m *MockRedis) SetBit(ctx context.Context, key string, offset int64, value int) *redis.IntCmd {
...
func (_m *MockRedis) SetEX(ctx context.Context, key string, value interface{}, expiration time.Duration) *redis.StatusCmd {
	ret := _m.Called(ctx, key, value, expiration)
...
func (_m *MockRedis) SetNX(ctx context.Context, key string, value interface{}, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, value, expiration)
...
func (_m *MockRedis) SetRange(ctx context.Context, key string, offset int64, value string) *redis.IntCmd {
	ret := _m.Called(ctx, key, offset, value)
...
func (_m *MockRedis) SetXX(ctx context.Context, key string, value interface{}, expiration time.Duration) *redis.BoolCmd {
	ret := _m.Called(ctx, key, value, expiration)
...
func (_m *MockRedis) Shutdown(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ShutdownNoSave(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) ShutdownSave(ctx context.Context) *redis.StatusCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) SlaveOf(ctx context.Context, host string, port string) *redis.StatusCmd {
	ret := _m.Called(ctx, host, port)
...
func (_m *MockRedis) Sort(ctx context.Context, key string, sort *redis.Sort) *redis.StringSliceCmd {
...
func (_m *MockRedis) SortInterfaces(ctx context.Context, key string, sort *redis.Sort) *redis.SliceCmd {
	ret := _m.Called(ctx, key, sort)
...
func (_m *MockRedis) SortStore(ctx context.Context, key string, store string, sort *redis.Sort) *redis.IntCmd {
...
func (_m *MockRedis) StrLen(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) TTL(ctx context.Context, key string) *redis.DurationCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Time(ctx context.Context) *redis.TimeCmd {
	ret := _m.Called(ctx)
...
func (_m *MockRedis) Touch(ctx context.Context, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) TxPipeline() redis.Pipeliner {
	ret := _m.Called()
...
func (_m *MockRedis) TxPipelined(ctx context.Context, fn func(redis.Pipeliner) error) ([]redis.Cmder, error) {
	ret := _m.Called(ctx, fn)
...
func (_m *MockRedis) Type(ctx context.Context, key string) *redis.StatusCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) Unlink(ctx context.Context, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) XAck(ctx context.Context, stream string, group string, ids ...string) *redis.IntCmd {
...
func (_m *MockRedis) XAdd(ctx context.Context, a *redis.XAddArgs) *redis.StringCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XAutoClaim(ctx context.Context, a *redis.XAutoClaimArgs) *redis.XAutoClaimCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XAutoClaimJustID(ctx context.Context, a *redis.XAutoClaimArgs) *redis.XAutoClaimJustIDCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XClaim(ctx context.Context, a *redis.XClaimArgs) *redis.XMessageSliceCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XClaimJustID(ctx context.Context, a *redis.XClaimArgs) *redis.StringSliceCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XDel(ctx context.Context, stream string, ids ...string) *redis.IntCmd {
	_va := make([]interface{}, len(ids))
	for _i := range ids {
		_va[_i] = ids[_i]
	}
...
func (_m *MockRedis) XGroupCreate(ctx context.Context, stream string, group string, start string) *redis.StatusCmd {
...
func (_m *MockRedis) XGroupCreateConsumer(ctx context.Context, stream string, group string, consumer string) *redis.IntCmd {
...
func (_m *MockRedis) XGroupCreateMkStream(ctx context.Context, stream string, group string, start string) *redis.StatusCmd {
	ret := _m.Called(ctx, stream, group, start)
...
func (_m *MockRedis) XGroupDelConsumer(ctx context.Context, stream string, group string, consumer string) *redis.IntCmd {
	ret := _m.Called(ctx, stream, group, consumer)
...
func (_m *MockRedis) XGroupDestroy(ctx context.Context, stream string, group string) *redis.IntCmd {
...
func (_m *MockRedis) XGroupSetID(ctx context.Context, stream string, group string, start string) *redis.StatusCmd {
	ret := _m.Called(ctx, stream, group, start)
...
func (_m *MockRedis) XInfoConsumers(ctx context.Context, key string, group string) *redis.XInfoConsumersCmd {
...
func (_m *MockRedis) XInfoGroups(ctx context.Context, key string) *redis.XInfoGroupsCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) XInfoStream(ctx context.Context, key string) *redis.XInfoStreamCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) XInfoStreamFull(ctx context.Context, key string, count int) *redis.XInfoStreamFullCmd {
	ret := _m.Called(ctx, key, count)
...
func (_m *MockRedis) XLen(ctx context.Context, stream string) *redis.IntCmd {
...
func (_m *MockRedis) XPending(ctx context.Context, stream string, group string) *redis.XPendingCmd {
	ret := _m.Called(ctx, stream, group)
...
func (_m *MockRedis) XPendingExt(ctx context.Context, a *redis.XPendingExtArgs) *redis.XPendingExtCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XRange(ctx context.Context, stream string, start string, stop string) *redis.XMessageSliceCmd {
...
func (_m *MockRedis) XRangeN(ctx context.Context, stream string, start string, stop string, count int64) *redis.XMessageSliceCmd {
...
func (_m *MockRedis) XRead(ctx context.Context, a *redis.XReadArgs) *redis.XStreamSliceCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XReadGroup(ctx context.Context, a *redis.XReadGroupArgs) *redis.XStreamSliceCmd {
	ret := _m.Called(ctx, a)
...
func (_m *MockRedis) XReadStreams(ctx context.Context, streams ...string) *redis.XStreamSliceCmd {
...
func (_m *MockRedis) XRevRange(ctx context.Context, stream string, start string, stop string) *redis.XMessageSliceCmd {
	ret := _m.Called(ctx, stream, start, stop)
...
func (_m *MockRedis) XRevRangeN(ctx context.Context, stream string, start string, stop string, count int64) *redis.XMessageSliceCmd {
	ret := _m.Called(ctx, stream, start, stop, count)
...
func (_m *MockRedis) XTrim(ctx context.Context, key string, maxLen int64) *redis.IntCmd {
...
func (_m *MockRedis) XTrimApprox(ctx context.Context, key string, maxLen int64) *redis.IntCmd {
	ret := _m.Called(ctx, key, maxLen)
...
func (_m *MockRedis) XTrimMaxLen(ctx context.Context, key string, maxLen int64) *redis.IntCmd {
	ret := _m.Called(ctx, key, maxLen)
...
func (_m *MockRedis) XTrimMaxLenApprox(ctx context.Context, key string, maxLen int64, limit int64) *redis.IntCmd {
...
func (_m *MockRedis) XTrimMinID(ctx context.Context, key string, minID string) *redis.IntCmd {
...
func (_m *MockRedis) XTrimMinIDApprox(ctx context.Context, key string, minID string, limit int64) *redis.IntCmd {
...
func (_m *MockRedis) ZAdd(ctx context.Context, key string, members ...*redis.Z) *redis.IntCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZAddArgs(ctx context.Context, key string, args redis.ZAddArgs) *redis.IntCmd {
...
func (_m *MockRedis) ZAddArgsIncr(ctx context.Context, key string, args redis.ZAddArgs) *redis.FloatCmd {
	ret := _m.Called(ctx, key, args)
...
func (_m *MockRedis) ZAddCh(ctx context.Context, key string, members ...*redis.Z) *redis.IntCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZAddNX(ctx context.Context, key string, members ...*redis.Z) *redis.IntCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZAddNXCh(ctx context.Context, key string, members ...*redis.Z) *redis.IntCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZAddXX(ctx context.Context, key string, members ...*redis.Z) *redis.IntCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZAddXXCh(ctx context.Context, key string, members ...*redis.Z) *redis.IntCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZCard(ctx context.Context, key string) *redis.IntCmd {
	ret := _m.Called(ctx, key)
...
func (_m *MockRedis) ZCount(ctx context.Context, key string, min string, max string) *redis.IntCmd {
...
func (_m *MockRedis) ZDiff(ctx context.Context, keys ...string) *redis.StringSliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) ZDiffStore(ctx context.Context, destination string, keys ...string) *redis.IntCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) ZDiffWithScores(ctx context.Context, keys ...string) *redis.ZSliceCmd {
	_va := make([]interface{}, len(keys))
	for _i := range keys {
		_va[_i] = keys[_i]
	}
...
func (_m *MockRedis) ZIncr(ctx context.Context, key string, member *redis.Z) *redis.FloatCmd {
	ret := _m.Called(ctx, key, member)
...
func (_m *MockRedis) ZIncrBy(ctx context.Context, key string, increment float64, member string) *redis.FloatCmd {
...
func (_m *MockRedis) ZIncrNX(ctx context.Context, key string, member *redis.Z) *redis.FloatCmd {
	ret := _m.Called(ctx, key, member)
...
func (_m *MockRedis) ZIncrXX(ctx context.Context, key string, member *redis.Z) *redis.FloatCmd {
	ret := _m.Called(ctx, key, member)
...
func (_m *MockRedis) ZInter(ctx context.Context, store *redis.ZStore) *redis.StringSliceCmd {
...
func (_m *MockRedis) ZInterStore(ctx context.Context, destination string, store *redis.ZStore) *redis.IntCmd {
...
func (_m *MockRedis) ZInterWithScores(ctx context.Context, store *redis.ZStore) *redis.ZSliceCmd {
	ret := _m.Called(ctx, store)
...
func (_m *MockRedis) ZLexCount(ctx context.Context, key string, min string, max string) *redis.IntCmd {
	ret := _m.Called(ctx, key, min, max)
...
func (_m *MockRedis) ZMScore(ctx context.Context, key string, members ...string) *redis.FloatSliceCmd {
	_va := make([]interface{}, len(members))
	for _i := range members {
		_va[_i] = members[_i]
	}
...
func (_m *MockRedis) ZPopMax(ctx context.Context, key string, count ...int64) *redis.ZSliceCmd {
...
func (_m *MockRedis) ZPopMin(ctx context.Context, key string, count ...int64) *redis.ZSliceCmd {
	_va := make([]interface{}, len(count))
	for _i := range count {
		_va[_i] = count[_i]
	}
...
func (_m *MockRedis) ZRandMember(ctx context.Context, key string, count int, withScores bool) *redis.StringSliceCmd {
...
func (_m *MockRedis) ZRange(ctx context.Context, key string, start int64, stop int64) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, start, stop)
...
func (_m *MockRedis) ZRangeArgs(ctx context.Context, z redis.ZRangeArgs) *redis.StringSliceCmd {
	ret := _m.Called(ctx, z)
...
func (_m *MockRedis) ZRangeArgsWithScores(ctx context.Context, z redis.ZRangeArgs) *redis.ZSliceCmd {
	ret := _m.Called(ctx, z)
...
func (_m *MockRedis) ZRangeByLex(ctx context.Context, key string, opt *redis.ZRangeBy) *redis.StringSliceCmd {
...
func (_m *MockRedis) ZRangeByScore(ctx context.Context, key string, opt *redis.ZRangeBy) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, opt)
...
func (_m *MockRedis) ZRangeByScoreWithScores(ctx context.Context, key string, opt *redis.ZRangeBy) *redis.ZSliceCmd {
	ret := _m.Called(ctx, key, opt)
...
func (_m *MockRedis) ZRangeStore(ctx context.Context, dst string, z redis.ZRangeArgs) *redis.IntCmd {
...
func (_m *MockRedis) ZRangeWithScores(ctx context.Context, key string, start int64, stop int64) *redis.ZSliceCmd {
	ret := _m.Called(ctx, key, start, stop)
...
func (_m *MockRedis) ZRank(ctx context.Context, key string, member string) *redis.IntCmd {
	ret := _m.Called(ctx, key, member)
...
func (_m *MockRedis) ZRem(ctx context.Context, key string, members ...interface{}) *redis.IntCmd {
	var _ca []interface{}
	_ca = append(_ca, ctx, key)
	_ca = append(_ca, members...)
	ret := _m.Called(_ca...)
...
func (_m *MockRedis) ZRemRangeByLex(ctx context.Context, key string, min string, max string) *redis.IntCmd {
	ret := _m.Called(ctx, key, min, max)
...
func (_m *MockRedis) ZRemRangeByRank(ctx context.Context, key string, start int64, stop int64) *redis.IntCmd {
	ret := _m.Called(ctx, key, start, stop)
...
func (_m *MockRedis) ZRemRangeByScore(ctx context.Context, key string, min string, max string) *redis.IntCmd {
	ret := _m.Called(ctx, key, min, max)
...
func (_m *MockRedis) ZRevRange(ctx context.Context, key string, start int64, stop int64) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, start, stop)
...
func (_m *MockRedis) ZRevRangeByLex(ctx context.Context, key string, opt *redis.ZRangeBy) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, opt)
...
func (_m *MockRedis) ZRevRangeByScore(ctx context.Context, key string, opt *redis.ZRangeBy) *redis.StringSliceCmd {
	ret := _m.Called(ctx, key, opt)
...
func (_m *MockRedis) ZRevRangeByScoreWithScores(ctx context.Context, key string, opt *redis.ZRangeBy) *redis.ZSliceCmd {
	ret := _m.Called(ctx, key, opt)
...
func (_m *MockRedis) ZRevRangeWithScores(ctx context.Context, key string, start int64, stop int64) *redis.ZSliceCmd {
	ret := _m.Called(ctx, key, start, stop)
...
func (_m *MockRedis) ZRevRank(ctx context.Context, key string, member string) *redis.IntCmd {
	ret := _m.Called(ctx, key, member)
...
func (_m *MockRedis) ZScan(ctx context.Context, key string, cursor uint64, match string, count int64) *redis.ScanCmd {
	ret := _m.Called(ctx, key, cursor, match, count)
...
func (_m *MockRedis) ZScore(ctx context.Context, key string, member string) *redis.FloatCmd {
	ret := _m.Called(ctx, key, member)
...
func (_m *MockRedis) ZUnion(ctx context.Context, store redis.ZStore) *redis.StringSliceCmd {
	ret := _m.Called(ctx, store)
...
func (_m *MockRedis) ZUnionStore(ctx context.Context, dest string, store *redis.ZStore) *redis.IntCmd {
...
func (_m *MockRedis) ZUnionWithScores(ctx context.Context, store redis.ZStore) *redis.ZSliceCmd {
	ret := _m.Called(ctx, store)
...
// NewMockRedis creates a new instance of MockRedis. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockRedis(t testing.TB) *MockRedis {
	mock := &MockRedis{}
	mock.Mock.Test(t)
